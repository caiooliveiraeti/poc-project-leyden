...
# Wait time (seconds) used between startup and actions; can be overridden via env
# Example: export SLEEP_SECONDS=8
...
build() {
    ...
    # Wait for startup (adjust via SLEEP_SECONDS env if needed)
    sleep "$SLEEP_SECONDS"
